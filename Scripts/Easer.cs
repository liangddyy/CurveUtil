...
public class Easer
{
    ...
    // Default: "EaserOutput/Resources"
    public const string DATA_PATH = "Out/Resources";

    // Default: "easer_data.asset"
    public const string DATA_FILENAME = "curve_data.asset";

    // Default: "EaserOutput/Enums"
    public const string ENUM_PATH = "Out/Enums";
    ...
    {
        return new Vector4(Ease(easeType, from.x, to.x, t), Ease(easeType, from.y, to.y, t),
            Ease(easeType, from.z, to.z, t), Ease(easeType, from.w, to.w, t));
    }
